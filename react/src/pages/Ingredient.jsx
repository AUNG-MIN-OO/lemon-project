					...
					<div className="ingredient-card">
						<div className="ingredient-card-left">
							<div className="ingredient-card-info">
								<h2>ランニングエッグ</h2>
								<p>
									ランニングエッグは黄身の色が濃く、味に力があります。焼菓子に使うと、バターや砂糖に負けない“卵の旨み”がしっかり感じられる仕上がりになります。濃厚なコクと自然な甘みがあり、焼き上がりに深みが生まれるため採用しています。
								</p>
							</div>
						</div>
					...
					<div className="ingredient-card">
						...
						<div className="ingredient-card-right">
							<div className="ingredient-card-info">
								<h2>瀬戸内の無農薬レモン</h2>
								<p>
									瀬戸内の太陽をたっぷり浴び、丁寧に育てられた無農薬レモン。農薬に頼らず手間ひまかけて育てられたその果実は、香り立ちが豊かで、皮ごと使用しても雑味がありません。素材そのものの上質さが、焼菓子に清々しい香りと奥行きをもたらします。
								</p>
							</div>
						</div>
					</div>
					...
					<div className="ingredient-card">
						...
						<div className="ingredient-card-right">
							<div className="ingredient-card-info">
								<h2>北海道バター</h2>
								<p>
									確かな品質で知られる北海道バターを使用しています。コクく豊かな香りが、焼菓子にしっかりとした味わいを与え、どなたにも愛されるおいしさに仕上げてくれます。
								</p>
							</div>
						</div>
					</div>
